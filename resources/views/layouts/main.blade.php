...
<head>
  ...
  <title>Dashboard | PT.Lancang Kuning Sukses</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light elevation-4"> <!-- Sidebar with light theme -->
  <!-- Brand Logo -->
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
          <a href="#" class="nav-link">
            ...
            <p>
              Batamindo
              <i class="right fas fa-angle-left"></i> <!-- Icon indicating dropdown -->
            </p>
          </a>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; PT.LKS Batam</a>.</strong>
    All rights reserved.
